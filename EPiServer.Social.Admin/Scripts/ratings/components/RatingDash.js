...
var EmitterService_1 = require("../../common/services/EmitterService");
// Component decorator
var RatingDashComponent = (function () {
    ...
    RatingDashComponent.prototype.loadRatingDash = function () {
        ...
        this.ratingService.getRatingsDash()
            .subscribe(function (dash) {
            _this.dash = dash;
            console.log('*****dash value: ' + JSON.stringify(_this.dash));
        }, //Bind to view
